...
public class JLabelSetPower extends JLabel{
	...
	public JLabelSetPower(GameFrame gf, int h){
	...
	public void updateImage(){
		int maxpower = gameFrame.getJPanelHome().getJPanelSetting().getMaxPower();
		hundred = numbers[maxpower/100];
		ten = numbers[maxpower/10%10];
		one = numbers[maxpower%10];
	}
