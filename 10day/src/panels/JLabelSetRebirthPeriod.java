...
public class JLabelSetRebirthPeriod extends JLabel{
	...
	public JLabelSetRebirthPeriod(GameFrame gf, int h) {
	...
	public void updateImage(){
		int rebirthperiod = gameFrame.getJPanelHome().getJPanelSetting().getRebirthPeriod();
		hundred = numbers[rebirthperiod/100];
		ten = numbers[rebirthperiod/10%10];
		one = numbers[rebirthperiod%10];
	}
